...
🟡 Missing `runMain` `syncBuiltinESMExports`, `Module#load()`, `module.register`, `module.syncBuiltinESMExports`, `module.findSourceMap`, `module.SourceMap`. Attempts to override or patch the module cache will fail.
